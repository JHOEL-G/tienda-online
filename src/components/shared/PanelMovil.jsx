    ...
    return (
        <div>
            ...
            <main className='lg:pl-25 grid grid-cols-1 lg:grid-cols-8 pb-10'>
                <div className='lg:col-span-6 md:p-8 p-5 bg-[#262837] lg:bg-transparent'>
                    ...
                    <div className='p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                        <div className='bg-[#1F1D2B] p-8 rounded-xl flex flex-col items-center gap-2 text-center text-gray-300'>
                            <img src="img1.png" alt="" className='w-40 h-40 object-cover -mt-20 shadow-2xl rounded-full' />
                ...
                <div className={`lg:col-span-2 fixed  top-0 bg-[#1F1D2B] w-full lg:w-90 lg:right-0 h-full transition-all ${Orden ? 'right-0' : '-right-full'}`}>
                    <div className='relative pt-16 lg:pt-8 text-gray-300 p-8 h-full'>
                        <VscChromeClose onClick={miOrden} className='lg:hidden absolute left-5 top-5 p-3 box-content text-gray-300 bg-[#262837] rounded-full text-xl' />
                        ...
                        <div>
                            ...
                            <div className='h-[400px] md:h-[700px] lg:h-[500px] overflow-scroll '>
                                <div className='bg-[#262837] p-4 rounded-xl mb-4'>
                                    <div className='grid grid-cols-6 mb-4'>
                                        <div className=' col-span-4 flex items-center gap-3'>
                                            <img src="img1.png" alt="" className='w-10 h-10 object-cover' />
                                            <div>
                                    ...
                                    {/* INICIO DEL CAMBIO */}
                                    <div className='grid grid-cols-6 items-center md:gap-13'> {/* Añade md:gap-4 aquí */}
                                        {/* Cambiamos col-span-5 a col-span-4 para dejar más espacio en escritorio */}
                                        <form action="" className='col-span-5 md:col-span-4'>
                                            <input type="text" className='bg-[#1F1D2B] py-2 px-4 rounded-lg outline-none w-full' placeholder='Order note' />
                                        </form>
                                        <div>
                                ...
                                <div className='bg-[#262837] p-4 rounded-xl mb-4'>
                                    ...
                                    {/* INICIO DEL CAMBIO */}
                                    <div className='grid grid-cols-6 items-center md:gap-4'> {/* Añade md:gap-4 aquí */}
                                        {/* Cambiamos col-span-5 a col-span-4 para dejar más espacio en escritorio */}
                                        <form action="" className='col-span-5 md:col-span-4'>
                                            <input type="text" className='bg-[#1F1D2B] py-2 px-4 rounded-lg outline-none w-full' placeholder='Order note' />
                                        </form>
